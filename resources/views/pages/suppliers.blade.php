  ...
  <section  class="p-10 h-screen w-screen bg-gray-standard relative">
    ...
    <div class="flex flex-col gap-4 ">
      <div class="flex gap-4 justify-end">
        <button data-button-target='create-supplier-modal' class="modal-trigger outline-none border-none px-4 py-2  text-white 
        ...
        @endif
        rounded-[10px]" 
          @if(auth()->user()->role->name==='admin')  @else disabled @endif>Add Supplier</button>
      </div>
